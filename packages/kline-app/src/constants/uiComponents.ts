...
export const LAYOUTS = [
    ...
    },
    {
        ...
        desc:
            "Bootstrap's powerful mobile-first flexbox grid to build layouts of all shapes and sizes",
...
const UIHOVER = [
    ...
    },
    {
        ...
        menuName: 'Link Hover',
        desc:
            'Link hover effect is triggered when a user places a mouse over a link',
    ...
    },
    {
        ...
        desc:
            'Overlay content is displayed when a user places a mouse over a designated area',
...
const UITYPOGRAPHY = [
    ...
    },
    {
        name: 'Typography',
        desc:
            'Typography is one of the most basic foundational part of a interface design system.',
...
export const UIKIT = [
    ...
    },
    {
        name: 'Box',
        desc:
            'A box is often used as a container to display content, it works like a Card.',
        path: '/app/ui/box',
    },
    {
        name: 'Color Palette',
...
const FORMCONTROLS = [
    {
        name: 'Rate',
        desc:
            'Rate component. Usage: Show evaluation. Or a quick rating operation on something.',
    ...
    },
    {
        name: 'Tree Select',
        desc:
            'Tree Select is similar to Select, but the values are provided in a tree like structure.',
    ...
    },
    {
        name: 'Radio',
        desc:
            'Radio. Usage: Used to select a single state in multiple options.',
        path: '/app/form/form-control/radio',
    },
    {
        name: 'Mention',
        desc:
            'Mention component. Usage: When need to mention someone or something.',
...
export const FEEDBACKS = [
    ...
    },
    {
        name: 'Alert',
        desc:
            'Alert component for feedback. Usage: When you need to show alert messages to users.',
