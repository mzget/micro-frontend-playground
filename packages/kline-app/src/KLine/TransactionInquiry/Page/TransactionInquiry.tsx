...
const TransactionInquiry = (props: any) => {
    ...
    const disabledStartDate = current => {
        return (
            current &&
            payment_end_date &&
            current >= payment_end_date.endOf("day")
        );
    };
    ...
    const disabledStartDate2 = current => {
        return (
            current &&
            cashback_end_date &&
            current >= cashback_end_date.endOf("day")
        );
    };
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Row>
                        <Col span={7}>
                            <Form.Item
                                ...
                                extra={
                                    <ErrorMessage errors={errors} name="mid" />
                                }
                            >
                                <Controller
                                    as={
                    ...
                    <Row>
                        ...
                        <Col span={8}>
                            <Form.Item
                                label={
                                    Locale.KLINE.TRANSACTION_INQ
                                        .SEARCHFORM_REFUND_STATUS
                                }
                            >
                    ...
                    <Divider />
                    <Section
                        label={Locale.KLINE.TRANSACTION_INQ.SEARCH_TRANS_RES}
                    >
