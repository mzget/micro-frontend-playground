...
const columns = [
    ...
    {
        title: Locale.KLINE.LIMIT_INQ.TABLE_HEADER_MERCHANT_ID,
        dataIndex: "mid",
        key: "mid",
    },
    {
...
const LimitTabCardPerMercTable = ({ dataSource }) => (
    <Table
        title={() => Locale.KLINE.LIMIT_INQ.TABLE_TITLE_CARD_PER_MERCHANT_LIMIT}
        columns={columns}
...
export default LimitTabCardPerMercTable;
